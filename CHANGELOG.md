...
## [[2.0.2](https://github.com/TerraDharitri/drt-lite-wallet-dapp/pull/92)] - 2025-06-04

- [Added ability to hide features pages based on config](https://github.com/TerraDharitri/drt-lite-wallet-dapp/pull/95)
- [Added ability to hide token transfer on sovereign](https://github.com/TerraDharitri/drt-lite-wallet-dapp/pull/91)

## [[2.0.1](https://github.com/TerraDharitri/drt-lite-wallet-dapp/pull/90)] - 2025-05-15

- [Update pacakges to latest versions](https://github.com/TerraDharitri/drt-lite-wallet-dapp/pull/89)
- [Fixed issue NFT has invalid collection name](https://github.com/TerraDharitri/drt-lite-wallet-dapp/pull/84)
- [Added WREWA to sovereign transfer](https://github.com/TerraDharitri/drt-lite-wallet-dapp/pull/83)

## [[2.0.0](https://github.com/TerraDharitri/drt-lite-wallet-dapp/pull/82)] - 2025-03-31

- [Upgrade to sdk-core v14 and sdk-dapp v4](https://github.com/TerraDharitri/drt-lite-wallet-dapp/pull/81)
