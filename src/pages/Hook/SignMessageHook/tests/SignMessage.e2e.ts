...
describe('Cancel sign message tests', () => {
  it('should cancel sign message and redirect to callbackUrl with status cancelled', async () => {
    ...
    expect(page.url()).toMatch(
      'https://devnet.dharitrix.com/?status=signed&signature=87ff670447448bdd1fa93c70b04627514b2ea220c8f98d0cc8e5be6113b47cef922fb6339b67aba7c292ab3ac73edc019aeb8da74880250390d7f9eb4f1d5f09'
    );
  });
});
