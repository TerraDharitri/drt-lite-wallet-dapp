...
describe('Send DCDT from dashboard tests', () => {
  it('should autocomplete the send form and send DCDT successfully', async () => {
    ...
    await expectInputToHaveValue({
      ...
      value: 'DCDTTransfer@4153482d653364316237@00'
    });
    ...
    await expectInputToHaveValue({
      dataTestId: DataTestIdsEnum.dataInput,
      value: 'DCDTTransfer@4153482d653364316237@0de0b6b3a7640000'
    });
